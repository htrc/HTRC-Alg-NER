...
import org.hathitrust.htrc.algorithms.namedentityrecognizer.Helper.{loadPropertiesFromClasspath, logger}
import org.hathitrust.htrc.algorithms.namedentityrecognizer.Main
